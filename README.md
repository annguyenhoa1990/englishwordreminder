...
1. Install dependencies:
   ...
   ```
2. Create a `.env` file by copying the example and filling in your SMTP credentials:
   ```bash
   cp .env.example .env
   ```
   Then open `.env` and replace the placeholder values with your SMTP host, email, and password.
